...
from data_processor import compute_stats
from html_helpers import create_stats_html
from plotly_scripts import create_plot_data_script, create_advanced_visualizations
...
def plot_selected_depts(df: pd.DataFrame, out_dir: Path, selected_depts: list = None, selected_univs: list = None, selected_subtypes: list = None, output_file: str = "선택된_모집단위들.html") -> str:
    """Generate an HTML report showing results per university for the selected departments."""
